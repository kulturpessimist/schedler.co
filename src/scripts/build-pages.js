...
const enrichContent = (content, page) => {
  ...
  const rules = {
    "start.txt": {
      ...
      //"scalable platforms": "<mark>scalable platforms</mark>",
      "digital transformation": "<mark>digital transformation</mark>",
      //"transformation": "<mark>transformation</mark>",
      "software architecture": "<mark>software architecture</mark>",
      //"architecture": "<mark>architecture</mark>",
      //"expertise": "<mark>expertise</mark>",
      "technology": "<mark>technology</mark>",
      "strategy": "<mark>strategy</mark>",
    ...
    "skills.txt": {
      "Leadership &": "<strong>Leadership &</strong>",
      "Core Strengths": "<strong>Core Strengths</strong>",
      "Leadership & Execution": "<i>Leadership & Execution</i>",
      "Stakeholder Communication": "<i>Stakeholder Communication</i>",
      "Languages": "<i>Languages</i>",
      "Technology Interests": "<i>Technology Interests</i>",
      //new: "<mark>new</mark>",
