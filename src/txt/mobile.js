...
`                                                        
    ...
    ║   Business management, marketing and legal   ║    
    ║                    issues                    ║    
    ║       Psychology, team management and        ║    
    ║                storyboarding                 ║    
...
`                                                        
   ...
   │  Download CV                                   │   
   │ =============                                  │   
   │ If you like my CV you can download a copy as   │   
...
`                                                        
   ...
   │ Webseite ist in der Regel ohne Angabe          │   
   ...
   │ Zustimmung nicht an Dritte weitergegeben. Wir  │   
   │ weisen darauf hin, dass die Datenübertragung   │   
...
`                                                        
   ...
   │ ====================                           │   
   │                                                │   
   │ Haftung für Inhalte: Als Diensteanbieter sind  │   
   │ wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf │   
